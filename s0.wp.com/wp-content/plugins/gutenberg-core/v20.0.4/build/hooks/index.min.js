    ...
    const n = function(t) {
        ...
        i = function(t, e) {
            return function(i, o, s, c = 10) {
                ...
                "hookAdded" !== i && t.doAction("hookAdded", i, o, s, c)
            }
        },
        o = function(t, e, i = !1) {
            return function(o, s) {
                ...
                if (!c[o]) return 0;
                let l = 0;
                if (i) l = c[o].handlers.length, c[o] = {
                    runs: c[o].runs,
                    handlers: []
                };
                else {
        ...
        c = function(t, e, n, r) {
            return function(i, ...o) {
                ...
                if (!c || !c.length) return n ? o[0] : void 0;
                const l = {
                    name: i,
                    currentIndex: 0
                };
                return (r ? async function() {
                    try {
                        ...
                        for (; l.currentIndex < c.length;) {
                            ...
                            t = await e.callback.apply(null, o), n && (o[0] = t), l.currentIndex++
                        }
                        return n ? t : void 0
                    } finally {
                    ...
                    try {
                        s.__current.add(l);
                        let t = n ? o[0] : void 0;
                        for (; l.currentIndex < c.length;) t = c[l.currentIndex].callback.apply(null, o), n && (o[0] = t), l.currentIndex++;
                        return n ? t : void 0
                    } finally {
                        s.__current.delete(l)
                    }
        ...
        l = function(t, e) {
            return function() {
                var n;
                const r = t[e],
                    i = Array.from(r.__current);
                return null !== (n = i.at(-1) ? .name) && void 0 !== n ? n : null
            }
        },
        a = function(t, e) {
            return function(n) {
        ...
        u = function(t, e) {
            return function(n) {
                const i = t[e];
                if (r(n)) return i[n] && i[n].runs ? i[n].runs : 0
            }
        };
    class d {
        constructor() {
